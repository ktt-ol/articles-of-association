...
\usepackage[]{scrpage2}
\usepackage{graphicx}
\usepackage[left=2cm, right=2cm, top=2cm, bottom=2.65cm]{geometry}
...
\Clause{title={Gegenseitige Rücksichtnahme}}
